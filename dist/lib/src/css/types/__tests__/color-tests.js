...
const parse = (value) => color.parse({}, Parser.parseValue(value));
describe('types', () => {
    describe('<color>', () => {
        describe('parsing', () => {
            ...
            it('hsla(.75turn, 60%, 70%, 50%)', () => strictEqual(parse('hsl(.75turn, 60%, 70%, 50%)'), parse('rgba(178,132,224, 0.5)')));
            it('lch(29.2345% 44.2 27 / 0.2)', () => strictEqual(parse('lch(29.2345% 44.2 27 / 0.2)'), pack(255, 148, 143, 0.2)));
