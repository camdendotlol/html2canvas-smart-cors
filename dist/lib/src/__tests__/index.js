...
describe('html2canvas', () => {
    ...
    it('should render with an element', async () => {
        ...
        expect(CanvasRenderer).toHaveBeenLastCalledWith(expect.objectContaining({
    ...
    it('should have transparent background with backgroundColor: null', async () => {
        ...
        expect(CanvasRenderer).toHaveBeenLastCalledWith(expect.anything(), expect.objectContaining({
