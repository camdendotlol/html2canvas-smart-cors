...
describe('cache-storage', function () {
    beforeEach(function () {
        setFeatures();
        for (var key in cache_storage_1.cache) {
            if (cache_storage_1.cache.hasOwnProperty(key)) {
                delete cache_storage_1.cache[key];
            }
        }
    });
    afterEach(function () {
    ...
    describe('cross-origin', function () {
        ...
        it('addImage should add images if cors enabled', function () {
            ...
            cache.addImage('http://html2canvas.hertzen.com/test.jpg');
            (0, assert_1.deepStrictEqual)(images.length, 1);
            (0, assert_1.deepStrictEqual)(removeQueryString(images[0].src), 'http://html2canvas.hertzen.com/test.jpg');
