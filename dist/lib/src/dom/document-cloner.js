import { isBodyElement, isCanvasElement, isCustomElement, isElementNode, isHTMLElementNode, isIFrameElement, isImageElement, isScriptElement, isSelectElement, isSlotElement, isStyleElement, isSVGElementNode, isTextareaElement, isTextNode, isVideoElement } from './node-parser';
import { isIdentToken, nonFunctionArgSeparator } from '../css/syntax/parser';
import { CounterState, createCounterText } from '../css/types/functions/counter';
import { listStyleType } from '../css/property-descriptors/list-style-type';
...
export class DocumentCloner {
    ...
    static destroy(ownerDocument, id) {
        const ownerContainer = ownerDocument.getElementById(id);
...
const addBase = (targetELement, referenceDocument) => {
